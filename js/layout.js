...
var cbpFixedScrollLayout = (function () {
    "use strict";
    var a = { $sections: $("#cbp-fbscroller > section"),
        $navlinks: $("nav > a"),
        currentLink: 0, $body: $("html, body"),
        animspeed: 650, animeasing: "easeInOutExpo"
    };
    function d() {
        a.$navlinks.on("click", function () {
            c(a.$sections.eq($(this).index()).offset().top); return false
        });
    ...
    { offset: "-30%" });
        $(window).on("debouncedresize", function () {
            // console.log(a.$sections.eq(a.currentLink).offset());
            if(a.$sections.eq(a.currentLink).offset() == undefined) {
                return;
            }
